  ...
  >
    ...
    <div class="px-7 py-5">
      <div class="mb-10">
        ...
        <div>
          <select class="form-select form-select-solid select2-hidden-accessible" v-model="data.application">
            <option value="">전체</option>
            <option value="Y">신청한 강의</option>
            <option value="N">신청하지 않은 강의</option>
          </select>
        </div>
      </div>
      <div class="mb-10">
