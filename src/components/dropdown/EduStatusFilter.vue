<template>
  ...
  >
    <div class="px-7 py-5 d-flex justify-content-between align-items-center">
      <div class="fs-5 text-gray-900 fw-bold">교육 상태 필터링</div>
      <button
          ref="closeButton"
          type="button"
    ...
    <div class="px-7 py-5">
      ...
      <!-- 과정명 필터 -->
      <div class="mb-10">
        <label class="form-label fw-semibold">과정명</label>
        <div>
          <input type="text" class="form-control form-control-solid" placeholder="과정명을 입력해주세요." v-model="data.courseName" />
        </div>
      </div>
      <!-- 프로그램명 필터 -->
      <div class="mb-10">
      ...
      <div class="mb-10">
        ...
        <div>
          <input type="text" class="form-control form-control-solid" placeholder="교육기관명을 입력해주세요." v-model="data.businessName" />
        </div>
      </div>
      <!-- 날짜 필터 -->
      <div class="mb-10">
