<template>
  ...
  >
    <div class="px-7 py-5 d-flex justify-content-between align-items-center">
      <div class="fs-5 text-gray-900 fw-bold">신청 조회 및 필터링</div>
      <button
          ref="closeButton"
          type="button"
    ...
    <div class="px-7 py-5">
      <div class="mb-10">
        ...
        <div>
          <select class="form-select form-select-solid select2-hidden-accessible" v-model="data.isConfirmed">
      ...
      <div class="mb-10">
        ...
        <div>
          <input type="number" class="form-control form-control-solid" placeholder="난이도를 입력해주세요." v-model="data.numberOfStudents" />
        </div>
      </div>
      <div class="mb-10">
