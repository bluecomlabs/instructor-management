                ...
                <div class="card-body border-top p-9">
                  ...
                  <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                      <!-- 여기에서 position-relative 클래스를 새로운 div에 적용 -->
                  ...
                  <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                      <!-- 여기에서도 position-relative 클래스를 새로운 div에 적용 -->
                      <div class="position-relative">
                        <div class="input-group">
                          <input
                            ...
                            <div class="row mb-6">
                              ...
                              <div class="d-flex align-items-center">
                                <input
                                  ...
                                  class="form-control form-control-solid me-2 text-center"
                                  type="time"
                                />
                                <span>~</span>
                                <input
                                  v-model="chapter.endTime"
                                  class="form-control form-control-solid ms-2 text-center"
                                  type="time"
                                />
                              </div>
                            </div>
  ...
  setup() {
    ...
    const fetchProgramData = async () => {
      ...
      try {
        ...
        selectedProgramId.value = programData.programId;
        selectedInstitutionId.value = programData.institutionId;
        chapterNumber.value = programData.chapterNumber;
        grade.value = programData.grade;
        isConfirmed.value = programData.isConfirmed;
        classNumber.value = programData.classNumber;
        numberOfStudents.value = programData.numberOfStudents;
        date.value = programData.date;
        remark.value = programData.remark;
        educationChapters.value = programData.educationChapters;

        institutionSearch.value = programData.institutionName;
        programSearch.value = programData.programName;
      } catch (error) {
    ...
    const goEdit = async () => {
      ...
      if (result.isConfirmed) {
        ...
        try {
          const token = localStorage.getItem('token');
          await axios.put(ApiUrl(`/api/v1/admin/apply-for-programs/${programId}`), payload, {
            headers: {
              'Authorization': `Bearer ${token}`,
