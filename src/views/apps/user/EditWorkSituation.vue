<template>
  ...
  <div class="d-flex flex-column flex-lg-row">
    ...
    <div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
      <EditWorkSituationDetail></EditWorkSituationDetail>
...
import EditWorkSituationDetail from "@/components/subscriptions/admin/EditWorkSituationDetail.vue";
